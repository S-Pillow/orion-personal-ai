# Orion Historical Docker Runtime Build Lineage

Status: **HISTORICAL / SUPERSEDED AS CONTROLLING ARCHITECTURE**

Source-preservation snapshot: August 27, 2026.  
Superseded as the controlling runtime on 2026-08-29 by **ORION — Master PRD v2.6 (AI-Optimized Execution Edition)** and the accepted native-Windows Phase 0 baseline.

> This file preserves the build lineage of the previously accepted Docker/container implementation. The hashes and image identities below remain valid historical evidence, but they are not the current Orion baseline and should not be used to rebuild or deploy the v2.6 runtime unless legacy recovery is explicitly requested.

## Historical accepted Hermes base
...
- historical custom image: `hermes-agent-local:v2026.8.18-ddgs`
- historical custom image ID: `sha256:17516e96105e957a192007cc8123f92d89b69e5676d41a8cb7bb3a42c25420f2`
- added package: `ddgs==9.14.4`
- preserved launcher SHA-256: `c265f485298d488bcd0a5f368138cef3b1db75bfddd831c794e5bbe06a411a7b`
- preserved Hermes Dockerfile SHA-256: `8f8a622761cf6a4b8a90af82688469e381c3814f15a0a4e681b25ef518f0e4e6`

## Historical iai image lineage
...
## Historical combined Hermes + iai

- M4 combined the historical Hermes custom base with `/opt/iai` from iai M2
...
- historical final image: `orion-hermes-iai:v2026.8.18-iai3.0.8-m5-serializerfix`
...
The old Docker rebuild work is frozen as evidence. It is not an active v2.6 rebuild target.

Preserved historical facts:

- launcher source preserved
- Hermes custom Dockerfile source preserved
- prior Phase 2/3 operational scripts preserved
- historical M2 and M5 build harnesses preserved
- prior disposable rebuild evidence remains in `build/orion-runtime/rebuild/` and `docs/rebuild/`

## Current native replacement

The current accepted Phase 0 baseline is native Windows:
...
Current reproduction source begins with `scripts/phase0/Orion-Phase0-Hermes-Native-AcceptedBaseline.ps1`. Phase 1 native iai work remains incomplete and is documented separately.
