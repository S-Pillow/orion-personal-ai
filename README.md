...
Canonical artifact and approval/change record:

- `docs/prd/orion-master-prd-v2.9-ai-optimized-approved.docx`
- `docs/prd/orion-master-prd-v2.9-approval-record-2026-09-24.md`

PRD v2.9 supersedes v2.8 while preserving the accepted native-Windows/manual-off foundation and the Hermes/iai/Obsidian/Orion authority split. v2.9 adds a truthful fact-to-projection/durability contract for the HUD, richer Phase 5 action evidence requirements, bounded Phase 4 recorder hardening, durability/corruption requirements for Phase 6 reminders, and an explicitly deferred bounded Persistent Goal Mode.

The pinned nanobot donor evidence used for those refinements is reference-only and recorded at `docs/research/nanobot-bounded-donor-evidence-2026-09-24.md`. It does not authorize a second gateway, runtime, memory engine, voice stack, scheduler, or agent system.
...
### Phase 5 — source/runtime qualification accepted through P5-02S production-move readiness
...
P5-02S production-move readiness is accepted on `feature/orion-phase5-p5-02s-production-move-readiness`. P5-02S-A created the controlled inbox draft `C:\Personal\Orion-Inbox\_Orion-P5-Move-Canary.md` with frozen SHA-256 `132ff51d62fd7fd8827d7222e233617e92c55dc21d40ff68164f2238ba0fd132`. P5-02S-B then froze Windows source file identity `5e1aeb8a1aeb5d91:eec0070000001f000000000000000000` and verified the registered move preview exactly matches the frozen absent-target/diff contract. Source remained unchanged, target remained absent, recovery stayed at 2 records / 0 attention, mutation mode stayed disabled, and Hermes stayed manual-off. P5-02T production move remains separately authorization-gated.
...
> Phase 3 presentation foundation accepted; Phase 4 voice work partially accepted with final live TTS/barge-in and wake disposition deferred; Phase 5 source/runtime safety is accepted through P5-02S, including the first bounded production edit, first production restore qualification, and first production-move readiness proof; mutation mode is disabled and Hermes remains manual-off. P5-02T/P5-02U remain separate authorization boundaries, and P5-03 is the planned truthful action-presentation/projection refinement.
